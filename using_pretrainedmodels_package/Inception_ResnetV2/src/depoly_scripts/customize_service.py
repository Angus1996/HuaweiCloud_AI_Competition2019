...
# class ImageClassificationService():
    def __init__(self, model_name, model_path):
        ...
        # self.model = models.__dict__['resnet152'](num_classes=54)
        # self.model = senet154(num_classes=54)
        self.model = pretrainedmodels.__dict__['inceptionresnetv2'](num_classes=54, pretrained=None)
        self.use_cuda = False
    ...
    def _inference(self, data):
        ...
        with torch.no_grad():
            ...
            if pred_score is not None:
                ...
                print(pred_label)
                pred_label = self.idx_to_class[str(pred_label)]
...
#     model_path = r'D:/Contest/Huawei_SENet154/model_best.pth'
#     infer = ImageClassificationService('', model_path)
#     img_path = 'D:/Contest/Huawei_SENet154/train_data/img_1.jpg'
#     img = Image.open(img_path)
#     img = infer.transforms(img)
#     data = {"input_img": img}
#     # result = infer._inference({"input_img": img})
#     result = infer.inference(data)
#     print(result)