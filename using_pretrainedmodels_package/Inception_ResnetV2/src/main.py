...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        ...
        if not mox.file.exists('../pre-trained_model/pytorch/inceptionresnetv2-520b38e4.pth'):
            mox.file.copy('s3://pytorch-inceptionresnetv2/weights/inceptionresnetv2-520b38e4.pth',
                          '../pre-trained_model/pytorch/inceptionresnetv2-520b38e4.pth')
            print('copy pre-trained model from OBS to: %s success' %
                  (os.path.abspath('../pre-trained_model/pytorch/inceptionresnetv2-520b38e4.pth')))
        else:
        ...
        # imageNet预训练参数
        model.load_state_dict(torch.load('../pre-trained_model/pytorch/inceptionresnetv2-520b38e4.pth'))
    else:
    ...
    # 修改最后的fc层
    fc_in_feas = model.last_linear.in_features
    model.last_linear = nn.Linear(fc_in_feas, args.num_classes)
