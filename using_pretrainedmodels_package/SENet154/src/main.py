...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        ...
        if not mox.file.exists('../pre-trained_model/pytorch/senet154-c7b49a05.pth'):
            mox.file.copy('s3://pytorchbucket/weights/senet154-c7b49a05.pth',
                          '../pre-trained_model/pytorch/senet154-c7b49a05.pth')
            print('copy pre-trained model from OBS to: %s success' %
                  (os.path.abspath('../pre-trained_model/pytorch/senet154-c7b49a05.pth')))
        else:
        ...
        # imageNet预训练参数
        model.load_state_dict(torch.load('../pre-trained_model/pytorch/senet154-c7b49a05.pth'))
    else:
